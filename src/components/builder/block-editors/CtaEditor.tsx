...
export function CtaEditor({
  ...
  return (
    <div className="grid gap-3">
      <Panel title="Content" description="Close the page with one clear next step.">
      ...
      <Panel title="Primary action" description="This should be the main conversion action.">
        ...
        <Field label="Primary URL" description="Use # for a placeholder, or paste a full URL.">
          <Input
      ...
      <Panel title="Secondary action" description="Optional supporting link for visitors not ready yet.">
