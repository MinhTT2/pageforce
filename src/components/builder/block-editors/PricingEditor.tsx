    ...
    <Panel title="Pricing">
      ...
      <ArrayItemEditor
        ...
        renderItem={(plan, update) => (
          <>
            <Field label="Name">
              <Input value={plan.name} onChange={(event) => update({ name: event.target.value })} />
            </Field>
            <Field label="Price">
              <Input value={plan.price} onChange={(event) => update({ price: event.target.value })} />
            </Field>
            ...
            <Field label="CTA URL">
              <Input value={plan.ctaUrl} onChange={(event) => update({ ctaUrl: event.target.value })} />
            </Field>
